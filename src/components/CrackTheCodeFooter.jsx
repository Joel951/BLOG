...
const CrackTheCodeFooter = () => {
  return (
    <>
      <div className="bg-customeBlue h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-20">
        <div className="p-5 ">
          <ul>
            <p className="text-white font-bold text-3xl pb-6">
              Crack the <span className="text-blue-600">Code</span>
            </p>
